...
def open_About():
    ...
    source_code_button.place(x=70, y=70)

    # Bouton : "LICENSE"
    license_button = tk.Button(About, text="Afficher la license", command=show_license, bg="#232F4E", fg=Colortext, bd=0)
    license_button.place(x=100, y=100)

    # Bouton : "LICENSE"
    debug_button = tk.Button(About, text="Créer un fichier de debugage", command=show_license, bg="#232F4E", fg=Colortext, bd=0)
    debug_button.place(x=130, y=130)

    #affichage crédit:
    credit = tk.Label(About, text="Dévellopé par : Pialleport Lucas & Wargnier Alexandre",font=('Bahnschrift SemiBold', 11), bg=ColorBackground, fg=Colortext)
    credit.place(x=17, y=270)  # POSITION DU TEXTE "Séléctionnez un format de sortie :"
